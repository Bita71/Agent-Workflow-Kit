...
description: Ask 1-3 blocking questions before implementation when missing answers could materially change the solution. Use before implementation, planning, or design-to-code work.
---
