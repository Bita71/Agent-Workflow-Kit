...
Apply a worktree's diff into the main checkout — only when the user explicitly
...
untracked files by copy; leave the result unstaged in the main checkout for the
